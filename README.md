...
Once the `conda-forge` channel has been enabled, `geant4-data-abla` can be installed with:

```
conda install geant4-data-abla
```

It is possible to list all of the versions of `geant4-data-abla` available on your platform with:
